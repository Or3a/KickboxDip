...
<head>
  ...
  <title>kickbox</title>
<style>.demo-card-square .mdl-card {
  width: 320px;
  height: 1020px;
}
...
include 'funksione/galeri.php'; ob_flush();
?>
<div class="mdl-grid">
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="Shporta.php?action=add&ID_produkte=<?php echo $row["ID_produkte"]; ?>">
                            ...
                            <div class="produkte">
                                ...
                                <div class="mdl-tooltip mdl-tooltip--large" for="tt1">Duhet te logoheni</div></div>
                               <?php } endif ?>
                            </div>
                        </form>
                    </div>
...
<div class="demo-card-square mdl-card mdl-shadow--2dp">
            ...
            <tr>
                ...
                <th class="th2">Cmimi</th>
                        ...
                        <tr> 
                             ...
                             <td align="right"><?php echo number_format($value['item_quantity'] * $value['product_price'], 2); ?> L</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <h6>Transporti</h6><h6 style="color:#2e7d32">FALAS</h6>
                        ...
                        <h5 class="th2"><b>+ TVSH <?php echo number_format($total, 2)*0.15; ?>Leke</b></h5>
                           <h4 class="th2"><b> Totali: <?php $_SESSION['CMIM_T'] = (number_format($total, 2)*1.15); echo number_format($total, 2)*1.15; ?>Leke</b></h4>
  ...
  <?php if (isLoggedSP()) : { ?>
           ...
           <button type="submit" name="porosit" class="mdl-button mdl-js-button" disabled>
            ...
            <div class="mdl-tooltip mdl-tooltip--large" for="tt2">Duhet te logoheni per te blere</div></div>
             <?php } endif ?>
             </form>
  </div>
</div>
