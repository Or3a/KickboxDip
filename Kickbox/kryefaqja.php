...
<?php include 'header.php'; ob_flush();?>
 ...
 <div class="logo-font kickbox-create-character"> 
        ...
        <div class="mdl-typography--display-1-color-contrast">Trajneret tane</div>
          ...
          <div class="kickbox-tv kickbox-trajner">
            <p><a class="kickbox-image-link" href="trajnerInfo.php#ilda">
              <img class="kickbox-trajner-image" src="images/ilda.png">
            </a></p>
            <p><a class="kickbox-link mdl-typography--font-regular mdl-typography--text-uppercase" href="trajnerInfo.php#ilda">ILDA LELO</a></p>
          </div>
          <div class="kickbox-tv kickbox-trajner">
          <p><a class="kickbox-image-link" href="trajnerInfo.php#ronald">
              <img class="kickbox-trajner-image" src="images/ronald.png">
            </a></p>
            <p><a class="kickbox-link mdl-typography--font-regular mdl-typography--text-uppercase" href="trajnerInfo.php#ronald">RONALD SKENDERI</a></p>
          </div>
          <div class="kickbox-tv kickbox-trajner">
          <p> <a class="kickbox-image-link" href="trajnerInfo.php#alban">
              <img class="kickbox-trajner-image" src="images/alban.png">
            </a>
            <p> <a class="kickbox-link mdl-typography--font-regular mdl-typography--text-uppercase" href="trajnerInfo.php#alban">ALBAN ALIKAJ</a></p>
          </div>
    ...
    <div class="container" id="content">
      <div class="row">
          ...
          <ul class="timeline">
            ...
            <li><pre><h3>Ora&emsp; &emsp;&emsp;&emsp;Dita</h3></pre></li>
...
<br/><br/>
 ...
 <br/>
  ...
  <iframe width="480" height="190" frameborder="0" src="https://www.openstreetmap.org/export/embed.html?bbox=19.476425171160376%2C40.46553703517908%2C19.496509552263895%2C40.475625078716135&amp;layer=mapnik&amp;marker=40.47058124637753%2C19.48646736171213"></iframe>
    <br/><a href="https://www.openstreetmap.org/?mlat=40.4706&amp;mlon=19.4865#map=16/40.4706/19.4865&amp;layers=N">Zmadho harten</a></small>
  </div>
</div>
